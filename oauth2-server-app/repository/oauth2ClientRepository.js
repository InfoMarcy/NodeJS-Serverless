// usuario model
const Oauth2Clientes = require("../model/userModel");
...
const logger = log4js.getLogger("oAuth2ClienteRepository");

// usuarios Object
let usuarios = [];

Oauth2Clientes.getAllOauth2Clientes(obj => {
...
module.exports = {
  ...
  getByClientId: function(clientId) {
    ...
    if (!validarJson.isEmptyObject(usuarios)) {
      for (var i = 0; i < usuarios.length; i++) {
        if (usuarios[i].clientId === clientId) {
          filteredByUserId.push(usuarios[i]);
        }
      }
